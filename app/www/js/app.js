    ...
    .state('profile.home', {
      ...
      views: {
        'menuHome': {
          ...
          resolve: {
            getGlobalStatistics: (MatchService) => MatchService.getGlobalStatisticsMatch(),
            getNameClub: (TeamService) => TeamService.nameTeam(),
            getLastMatchs: (MatchService) => MatchService.getLastMatchs()
          }
        }
      }
    })
